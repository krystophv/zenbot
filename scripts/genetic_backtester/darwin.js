...
let runCommand = (taskStrategyName, phenotype, cb) => {
  ...
  let strategyArgs = {
    ...
    crossover_vwap_rolling: `--ema_length=${phenotype.ema_length} --vwap_length=${phenotype.vwap_length}`,
    ...
    timeseries_analysis: `--lookback_mean=${phenotype.lookback_mean} --num_predictions=${phenotype.num_predictions} --smoothing=${phenotype.smoothing}`,
...
let strategies = {
  ...
  crossover_vwap_rolling: {
    // -- common
    period_length: RangePeriod(1, 1, 'm'),
    min_periods: Range(1, 400),
    markdown_buy_pct: RangeFloat(-1, 5),
    markup_sell_pct: RangeFloat(-1, 5),
    order_type: RangeMakerTaker(),
    sell_stop_pct: RangeFloat0(0, 5),
    buy_stop_pct: RangeFloat0(0, 5),
    profit_stop_enable_pct: RangeFloat0(0, 5),
    profit_stop_pct: RangeFloat0(0, 5),
  ...
  timeseries_analysis: {
    // -- common
    periodLength: RangePeriod(1, 200, 'm'),
    min_periods: Range(1, 100),
